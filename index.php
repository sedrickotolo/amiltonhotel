...
<html lang="en">
<head>
<title>Amilton Hotel Lira</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@Amilton Hotel.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">AMILTON <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Amilton Hotel Lira</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Amilton Hotel Lira is located in Lira town along Aduku road <BR> .</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 AMILTON Hotel . All Rights Reserved | Design by <a href="https://www.kakebe.com">KAKEBE TECHNOLOGIES LTD</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
